...
function testwin() {
    if (fields[0] + fields[1] + fields[2] == 0) {
        alert("Spieler 2 Gewinnt");
        neustart();
    }
    if (fields[0] + fields[1] + fields[2] == 3) {
        alert("Spieler 1 Gewinnt");
        neustart();
    }
    if (fields[3] + fields[4] + fields[5] == 0) {
        alert("Spieler 2 Gewinnt");
        neustart();
    }
    if (fields[3] + fields[4] + fields[5] == 3) {
        alert("Spieler 1 Gewinnt");
        neustart();
    }
    if (fields[6] + fields[7] + fields[8] == 0) {
        alert("Spieler 2 Gewinnt");
        neustart();
    }
    if (fields[6] + fields[7] + fields[8] == 3) {
        alert("Spieler 1 Gewinnt");
        neustart();
    }

    if (fields[0] + fields[3] + fields[6] == 0) {
        alert("Spieler 2 Gewinnt");
        neustart();
    }
    if (fields[1] + fields[4] + fields[7] == 0) {
        alert("Spieler 2 Gewinnt");
        neustart();
    }
    if (fields[2] + fields[5] + fields[8] == 0) {
        alert("Spieler 2 Gewinnt");
        neustart();
    }
    if (fields[0] + fields[3] + fields[6] == 3) {
        alert("Spieler 1 Gewinnt");
        neustart();
    }
    if (fields[1] + fields[4] + fields[7] == 3) {
        alert("Spieler 1 Gewinnt");
        neustart();
    }
    if (fields[2] + fields[5] + fields[8] == 3) {
        alert("Spieler 1 Gewinnt");
        neustart();
    }

    if (fields[0] + fields[4] + fields[8] == 0) {
        alert("Spieler 2 Gewinnt");
        neustart();
    }
    if (fields[2] + fields[4] + fields[6] == 0) {
        alert("Spieler 2 Gewinnt");
        neustart();
    }

    if (fields[0] + fields[4] + fields[8] == 3) {
        alert("Spieler 1 Gewinnt");
        neustart();
    }
    if (fields[2] + fields[4] + fields[6] == 3) {
        alert("Spieler 1 Gewinnt");
        neustart();
    }
}